...
Think of the [HTML5](guides/1.3/helpers/html5) or the [routing](guides/1.3/helpers/routing) helpers, they provide hundreds of methods to map tags or application routes.
