...
In the [overview](guides/1.3/helpers/overview) section, we introduced the design for helpers.
...
As third step, we include the module in all the views. See [View's Share Code](guides/1.3/views/share-code) section for low level details.
