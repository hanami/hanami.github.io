...
A view can handle several MIME Types. Before diving into this subject, please consider to read how actions handle [MIME Types](guides/1.3/actions/mime-types).
...
What if we want to have a [custom rendering](guides/1.3/views/basic-usage) or different presentational logic?
