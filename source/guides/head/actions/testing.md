...
The [implicit returning value](/guides/head/actions/rack-integration) is a serialized Rack response.
...
Because we want to make `@user` available to the outside world, we're going to use an [_exposure_](/guides/head/actions/exposures).
