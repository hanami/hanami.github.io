...
In the [previous section](/guides/head/mailers/overview), we generated a mailer, let's use it.
...
Similarly to a [view](/guides/head/views/basic-usage), a mailer can have a set of _locals_ that can be passed as an argument in order to make them available during the rendering.
