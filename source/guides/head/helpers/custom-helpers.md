...
In the [overview](/guides/head/helpers/overview) section, we introduced the design for helpers.
...
As third step, we include the module in all the views. See [View's Share Code](/guides/head/views/share-code) section for low level details.
