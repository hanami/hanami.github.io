...
Think of the [HTML5](/guides/head/helpers/html5) or the [routing](/guides/head/helpers/routing) helpers, they provide hundreds of methods to map tags or application routes.
