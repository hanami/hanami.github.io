...
By default, a repository performs auto-mapping of corresponding database table and creates an [automatic schema](/guides/head/models/entities#automatic-schema) for the associated entity.
