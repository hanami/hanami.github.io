...
_Code reloading_ allows us to edit code and see the changes with a browser refresh, without needing to stop and restart the [server](/guides/head/command-line/applications).
...
group :development do
  # Code reloading
  # See: http://hanamirb.org/guides/head/projects/code-reloading
  gem 'shotgun'
end
```
