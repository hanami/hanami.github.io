...
In the [previous section](/guides/head/views/overview) we generated a view. Let's use it.
...
There is another source for our context: [_exposures_](/guides/head/actions/exposures).
...
If an action assigns the body of the response with `#body=`, the rendering of the view is [bypassed](/guides/head/actions/basic-usage).
